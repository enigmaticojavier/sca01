...
<s:form>  
  ...
  <s:textfield label="Denominación" name="txtRazonSocial" value="" />
  <s:select name="tipParametro" value="tipParametro" list="lstTipoAcae" listKey="tipParametro" listValue="txtParametro" onchange="javascript:cambiarTipoParametro()"/>
